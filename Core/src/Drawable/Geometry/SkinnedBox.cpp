	...
	TestObject(gfx, rng, adist, ddist, odist, rdist)
{
	...
	if (!IsStaticInitialized())
	{
		...
		AddStaticBind(std::make_unique<Texture>(gfx, Surface::FromFile("Images/wood.jpg")));
		...
		AddStaticBind(std::make_unique<PixelShader>(gfx, L"Shaders/cso/TexturedPhongPS.cso"));
	...
	TestObject(gfx, rng, adist, ddist, odist, rdist)
{
	...
	if (!IsStaticInitialized())
	{
		...
		AddStaticBind(std::make_unique<PixelShader>(gfx, L"Shaders/cso/TexturePS.cso"));
