...
#include "Drawable/Geometry/IndexedTriangleList.h"
...
namespace D3DEngine
{
	...
	{
		public:
			static IndexedTriangleList MakeTesselatedTextured(RawVertexBufferWithLayout layout, int divisions_x, int divisions_y)
			{
			...
			{
				DynamicVertexLayout vl;
				vl.Append(DynamicVertexLayout::Position3D);
				vl.Append(DynamicVertexLayout::Normal);
				vl.Append(DynamicVertexLayout::Texture2D);
