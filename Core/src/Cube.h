...
namespace D3DEngine
{
	...
	{
		public:
			static IndexedTriangleList MakeIndependent(DynamicVertexLayout layout)
			{
				using Type = DynamicVertexLayout::ElementType;

				constexpr float side = 1.0f / 2.0f;

				RawVertexBufferWithLayout vertices(std::move(layout), 24u);
			...
			static IndexedTriangleList MakeIndependentTextured()
			{
				...
				auto itl = MakeIndependent(std::move(DynamicVertexLayout{}
